...
from langchain.chat_models import ChatOpenAI  # Corrected import for chat models
...
def load_llm():
    ...
    llm = ChatOpenAI(api_key=api_key, model="gpt-3.5-turbo")  # Corrected for chat-based model
    return llm
...
async def start():
    ...
    try:
        ...
        while True:
            ...
            # Sleep to avoid high CPU usage and allow for proper microphone handling
